...
<head>
    ...
    <style>
        ...
        .slider-container .action-buttons .act_btn {
            position: absolute;
            left: 35%;
            top: 50%;
            z-index: 100;
...
<body>
    ...
    <section style="margin-top: -10px;">
        <div class="slider-container img-fluid">
            ...
            <div class="right-slide">
                ...
                <div class="img-fluid"
                    style="background-image: url('assests/images/update_img/best_pamplates_reations_bhavi_creations_wide_2.webp ')">
                </div>
                <div class="img-fluid"
                    style="background-image: url('assests/images/update_img/best_pamplates_reations_bhavi_creations_wide_4.webp')">
                </div>
                <div class="img-fluid"
                    style="background-image: url('assests/images/update_img/best_pamplates_reations_bhavi_creations_wide.webp')">
                </div>
                <div class="img-fluid"
                    style="background-image: url('assests/images/update_img/best_pamplates_reations_bhavi_creations_wide_3.webp') ">
                </div>
            </div>
            <div class="action-buttons">
                <button class="down-button act_btn">
                ...
                <button class="up-button act_btn">
    ...
    <section class="mt-5">
        <div class="container">
            <div class="row" style="justify-content: space-evenly;">
                <div class="col-lg-5 order-1 order-sm-1 order-lg-1 mt-4">
                    <div class="col-lg-12 order-sm-1 d-flex flex-column justify-content-center card">
                        <h2 class="mt-5 text-center mix_up_text" style="font-size: 24px;">Captivating Pamphlets for
                            Effective Marketing</h2>

                        <p class="text-center m-3">Elevate your marketing strategy with captivating pamphlets designed
                            to engage and inform your audience. At Bhavi Creations, we specialize in creating visually
                            appealing pamphlets tailored to your unique needs, helping you stand out and make a lasting
                            impression.</p>
                    </div>
                </div>
                <div class="col-lg-5 order-2 mt-4 order-sm-2 order-lg-2" style="justify-content: center;">
                    <img src="assests/images/update_img/best_pamplates_reations_bhavi_creations_medium_1.webp" alt=""
                        class=" img-fluid  text-center">
                </div>
                <div class="col-lg-5 order-4 mt-4 order-sm-4 order-lg-3">
                    <img src="assests/images/update_img/best_pamplates_reations_bhavi_creations_medium_2.webp" alt=""
                        class="img-fluid text-center">
                </div>
                <div class="col-lg-5 mt-4 order-3 order-sm-3 order-lg-4">
                    <div class="col-lg-12 col-md-12 order-md-1 mt-5 card d-flex flex-column justify-content-center">

                        <h2 class="mt-5 text-center mix_up_text" style="font-size: 24px;">Informative Pamphlets for
                            Effective Communication</h2>

                        <p class="text-center m-3">Ensure effective communication with informative pamphlets designed to
                            convey your message clearly and concisely. Our expert team at Bhavi Creations crafts
                            engaging pamphlets that captivate your audience's attention and deliver your message with
                            impact.</p>
    ...
    <section class="mt-5 sec2">
        <div class="container">
            <div class="row mt-5" style="justify-content: space-evenly;">
                <div class="card_pham m-5 col-lg-3 col-md-12">
                    <img src="assests/images/update_img/best_pamplates_reations_bhavi_creations_mini_1.webp"
                        class="img-fluid " alt="">

                    <div class="card__content ">
                        <p class="card__title">Engaging Content</p>
                        <p class="card__description">Craft compelling content that resonates with your audience and
                            sparks interest in your products or services.</p>
                    </div>
                </div>
                <div class="card_pham my-5 col-lg-3 col-md-12">
                    <img src="assests/images/update_img/best_pamplates_reations_bhavi_creations_mini_2.webp"
                        class="img-fluid " alt="">

                    <div class="card__content">
                        <p class="card__title">Visually Appealing Design</p>
                        <p class="card__description">Capture attention with visually striking designs that enhance the
                            readability and impact of your pamphlets.</p>
                    </div>
                </div>
                <div class="card_pham m-5 col-lg-3 col-md-12">
                    <img src="assests/images/update_img/best_pamplates_reations_bhavi_creations_mini_3.webp"
                        class="img-fluid " alt="">
                    <div class="card__content">
                        <p class="card__title">Customized Solutions</p>
                        <p class="card__description">Tailor your pamphlets to suit your specific needs, whether it's
                            promoting an event, showcasing products, or communicating important information.</p>
                    </div>
                </div>
        ...
        <div class="container mt-5 mb-5">
            <div class="row">
                <div class=" col-xs-12 col-lg-4  col-sm-12 col-md-4 mb-5">
                    <img src="assests/images/update_img/best_pamplates_reations_bhavi_creations.webp" alt=""
                        class="img-fluid" style="border-radius: 8px;">
                </div>
                <div class=" col-xs-12 col-lg-4  col-sm-12 col-md-4 mb-5">
                    <img src="assests/images/update_img/best_pamplates_reations_bhavi_creations_two.webp" alt=""
                        class="img-fluid" style="border-radius: 8px;">
                </div>
                <div class=" col-xs-12 col-lg-4  col-sm-12 col-md-4 mb-5">
                    <img src="assests/images/update_img/best_pamplates_reations_bhavi_creations_3.webp" alt=""
                        class="img-fluid" style="border-radius: 8px;">
                </div>
                <!-- <h1 class="text-center mt-5 animated  backInRight"> <i>BROCHERS</i></h1>
                <h3 class="text-center mt-3" >Unlocking the Power of Brochures in Marketing</h3> -->
            </div>
        </div>
    </section>
