...
<body>
    ...
    <div class="container">
        ...
        <div class="row g-2 mb-4 row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6 media-tab-buttons mx-1 justify-content-center align-items-center">
            <div><button class="media-tab-btn active" onclick="showMediaTab(event, 'testimonials')">testimonials</button></div>
            ...
            <div><button class="media-tab-btn" onclick="showMediaTab(event, 'testimonials')">testimonials</button></div>
            <div><button class="media-tab-btn" onclick="showMediaTab(event, 'testimonials')">Testimonials</button> </div>
            <div><button class="media-tab-btn" onclick="showMediaTab(event, 'animatedtestimonials')">Animated testimonials</button></div>
        ...
        <div id="testimonials" class="media-tab-content active">
            <div class="row">
        ...
        <div id="testimonials" class="media-tab-content">
            <div class="row">
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    echo "<div class='col-12'><p class='text-muted text-center'>No testimonials media uploaded yet.</p></div>";
                }
        ...
        <div id="animatedtestimonials" class="media-tab-content">
            <div class="row">
                <?php
                include 'db.connection/db_connection.php'; // Adjust if path differs

                $sql = "SELECT * FROM our_works WHERE media_type = 'Animated testimonials' ORDER BY id DESC";
                $result = $conn->query($sql);
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    echo "<div class='col-12'><p class='text-muted text-center'>No animated testimonials uploaded yet.</p></div>";
                }
    ...
    <script>
        ...
        function showTabFromHash() {
            ...
            const validTabs = ['testimonials', 'all', 'images', 'testimonials', 'logos']; // Add more if needed

            const defaultTab = 'testimonials';
