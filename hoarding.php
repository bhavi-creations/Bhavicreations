...
<head>
    ...
    <title>Hoardings Bhavi Creations</title>
...
<body style="background-color: rgb(255, 255, 255);">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-5">
                    <h1 class="mb-3 animate_animated animate_lightSpeedInLeft large_text" ">Embrace
                        Traditional Branding with Hoardings</h1>
                    <p class=" mb-3 animate_animated animate_lightSpeedInRight">In today's digital age, traditional
                        branding methods like hoardings continue to play a crucial role in capturing audience attention
                        and promoting brand awareness. With their large size and strategic placement in high-traffic
                        areas, hoardings offer a powerful way to make a lasting impression and reach a wide audience
                        effectively. </span></p>

                        <div class="d-none d-lg-block">
                            <p class="mb-3 animate_animated animate_lightSpeedInLeft">At Bhavi Creations, we specialize
                                in
                                creating eye-catching hoardings that resonate with your target audience and leave a
                                memorable impact.</span></p>
                        </div>

                        <div class="d-none d-lg-block hoverng_btn_margin animate_animated animate_flipInX">
                            <a href="contact_us.php"> <button class="hoarding_btn">
                                    Contact Us
                                    <div class="icon-1">
                ...
                <div class=" d-none d-md-block col-7 ">
                    <div class="">
                        <img src="assests/images/online-branding/hoarding 1.webp" class="img-fluid" alt="">
                    </div>
                </div>
            </div>

            <div class=" d-block d-md-none col-7" style="margin-left: 80px;">
                <img src="assests/images/bhavi/hoarding_page.webp" class="img-fluid" alt="">
            </div>

            <div class="d-block d-lg-none">
                <p class="mb-3">At Bhavi Creations, we specialize in creating eye-catching hoardings that resonate with
                    your target audience and leave a memorable impact.</span></p>
            </div>
        ...
        <div class="container shadow">
            <div class="row">
                <div class="col-md-5 d-flex flex-column justify-content-center text-center">
                    <img src="assests/images/Bhavi_Creations/hoarding 11(413 x 253 px).webp" class="img-fluid" alt="">
                </div>
                <div class="col-md-7 p-5">
                    <h2 class="large_text">Let's Connect</h2>
                    <p>Ready to elevate your brand visibility with impactful hoardings? Get in touch with us today to
                        discuss your traditional branding needs and explore customized solutions for your business.</p>
                    <hr style="border-color: rgb(0, 0, 0); border-width: 2px; ">
                    <div class="row d-flex flex-row justify-content-center">
                        <!-- <div class="col-6 " style="font-weight: bold;"> <h3> <strong> Bhavi</strong></h3></div> -->
                        <div class="col-6">
                            <a href="contact_us.php" style="text-decoration: none;">
                                <button class="blabla type1">
    ...
    <section style="margin-top: 80px;">
        <div class="container my-5 d-none d-md-block  ">
            <div class="row ">
                ...
                <div class=" container col-8">
                    ...
                    <div class=" ">
                        <img src="assests/images/Bhavi_Creations/hoarding11.webp" class="img-fluid" alt="">
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <img src="assests/images/Bhavi_Creations/hoarding12 (413 x 253 px) (223 x 183 px).webp"
                                class=" img-fluid" alt="">
                        </div>

                        <div class="col-7">
                            <img src="assests/images/Bhavi_Creations/hoarding 11(413 x 253 px).webp" class=" img-fluid "
                                alt="">
                        </div>
                    </div>
                ...
                <div class="contaner col-4">


                    <div class="col-12">
                        <img src="assests/images/Bhavi_Creations/hoarding13 (319 x 439 px).webp" class="img-fluid"
                            alt="">
                    </div>
        ...
        <div class="container my-5 d-block d-md-none  ">
            <div class="row ">
                ...
                <div class="text-center my-4">
                    <img src="assests/images/Bhavi_Creations/hoarding13 (319 x 439 px).webp" class=" img-fluid" alt="">
                </div>
            </div>
        </div>
        </div>
    ...
    <section style="background-color: rgb(67, 72, 92);  margin-top: 80px; ">
        <div class="container">
            <div class="row">

                <div class="  col-5 d-none d-lg-block pt-5">
                    <img src="assests/images/Bhavi_Creations/hoarding 11(413 x 253 px).webp" class="img-fluid" alt="">
                </div>
                <div class=" col-12 col-lg-7 p-5">
                    <h1 style="color: white;">Benefits of Traditional Branding Hoardings</h1>
                    <p style="color: white;"> In an increasingly digital world, traditional branding methods like
                        hoardings offer unique advantages for businesses seeking to stand out in the physical landscape.
                        With their ability to command attention, convey key messages, and create a strong visual
                        presence, hoardings provide a cost-effective way to reach a broad audience and reinforce brand
                        recognition. </p>
                    <p style="color: white;">Partnering with Bhavi Creations ensures that your hoardings are expertly
                        designed, strategically placed, and optimized to maximize impact and drive results.</p>
                </div>
