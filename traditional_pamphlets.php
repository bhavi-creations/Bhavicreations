...
<head>
    ...
    <title>plamplate Bhavi Creations</title>
...
<body style="background-color: rgb(255, 255, 255);">
    ...
    <section style="margin-top:  80px; margin-bottom: 50px;">
        <div class="container">
            <div class="row">
                <div class=" col-sm-12 col-lg-4">

                    <div class="  only_for_sm_md">

                        <h1 class="large_text">
                            Embrace Tradition with Timeless Pamphlet Designs
                        </h1>
                        <p>In today's digital age, traditional pamphlets continue to hold significant value as a
                            tangible marketing tool. At Bhavi Creations, we understand the importance of preserving this
                            timeless tradition while infusing modern design elements to captivate your audience and
                            convey your message effectively.</p>
                        <p>Our custom-designed pamphlets combine the charm of traditional print with innovative design
                            techniques, ensuring that your marketing collateral stands out and leaves a lasting
                            impression.</p>

                    </div>
                    <!-- <div class="my-2 second_div d-none d-lg-block">

                    <h1 style="font-weight: bold; color: rgb(123, 123, 123);">
                        Get Your Best Designs
                    </h1>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Labore nihil quibusdam temporibus nisi molestiae at et inventore, repudiandae molestias, accusantium ullam enim dicta numquam, iure facere ducimus placeat doloribus pariatur!</p>
            
                </div> -->
                </div>
                <div class=" col-sm-12 col-lg-8 animate_animated animate_swing ">
                    <img src="assests/images/online-branding/phamplet_design1.webp" class="img-fluid" alt="">
                </div>
    ...
    <section class="  " style="margin-top:  80px; ">
        ...
        <div class="container px-5 d-none  d-lg-block">
            ...
            <div class="card-deck">
                <div class="card   " style="border: none;">
                    ...
                    <h1 class="card-title  large_text "> Explore Our Pamphlet Collection</h1>
                    <p class="card-text">Our pamphlet collection offers a diverse range of designs tailored to suit your
                        unique marketing needs. </p>


                </div>
                <div class="card  shadow ">
                    <img src="assests/images/online-branding/phamplet2.webp" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title mini_text_light_blue">Vibrant Designs </h5>
                        <hr style="border: 2px solid rgb(255, 1, 1);">

                        <p class="card-text">Command attention with eye-catching pamphlet designs perfect for events,
                            products, or services.</p>
                    </div>
                </div>
                <div class="card  shadow">
                    <img src="assests/images/online-branding/phamplet3.webp" class="card-img-top" alt="...">
                    <div class="card-body ">
                        <h5 class="card-title mini_text_light_blue"> Minimalist Elegance</h5>
                        <hr style="border: 2px solid rgb(255, 1, 1);">

                        <p class="card-text"> Convey sophistication with sleek and refined pamphlet designs ideal for
                ...
                <div class="card shadow">
                    <img src="assests/images/online-branding/phamplet2.webp" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title mini_text_light_blue">Creative Concepts</h5>
                        <hr style="border: 2px solid rgb(255, 1, 1);">

                        <p class="card-text">Inject personality into your marketing with innovative pamphlet designs
        ...
        <div class="container px-5 d-block d-lg-none">


            <div class="row justify-content-center">
                <div class="card  col-sm-12 col-md-5 mx-3  mt-2" style="border: none ;  ">
                ...
                <div class="card shadow  col-sm-12 col-md-5   mx-3   mt-2 ">
                    <img src="assests/images/online-branding/phamplet2.webp" class="card-img-top mt-3 shadow" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Vibrant Designs </h5>
                        <hr style="border: 2px solid rgb(255, 1, 1);">
                ...
                <div class="card shadow col-sm-12 col-md-5 mx-3  mt-2  ">
                    <img src="assests/images/online-branding/phamplet3.webp" class="card-img-top mt-3 shadow" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Minimalist Elegance</h5>
                        <hr style="border: 2px solid rgb(255, 1, 1);">
                ...
                <div class="card shadow col-sm-12 col-md-5 mx-3  mt-2 ">
                    <img src="assests/images/online-branding/phamplet2.webp" class="card-img-top mt-3 shadow" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Creative Concepts</h5>
                        <hr style="border: 2px solid rgb(255, 1, 1);">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-5 d-flex flex-column justify-content-center">
                    <img src="assests/images/online-branding/phamplet4.webp" class=" img-fluid" alt="">
                </div>
                ...
                <div class="col-7">
                    ...
                    <div class="row ">
                        <div class="col-3 mr-5">
                            <h1 class="large_text">Partner with Bhavi Creations</h1>
                        </div>
                        ...
                        <div class="col-8 d-none d-md-block">
                            <p>Partner with Bhavi Creations to transform your marketing collateral into impactful brand
                                assets that resonate with your target audience. Our team of experienced designers will
                                work closely with you to understand your brand identity, messaging, and goals, crafting
                                custom pamphlet designs that capture the essence of your brand and communicate your
                    ...
                    <div class="d-none d-lg-block">
                        <div class="mt-5">
                            <p>
                                Stand out from the competition and make a lasting impression with professionally
                                designed pamphlets from Bhavi Creations.
                            </p>
                        </div>
                    </div>
                    <div class="mt-1 d-none d-xl-block">
                        <a href="contact_us.php" style="text-decoration: none;"> <button class=" know_more_btn"
                                style="color: #032792 !important; ">contact us
                            </button></a>
                    </div>

                    <!-- <div class="d-none d-xl-block">

                    <div class="row  three_img_sec_3 " >

                    <div class="col-4">
                        <img src="assests/images/bhavi/small screen.jpg"  class="img-fluid" alt="">
                    </div>
                ...
                <div class="col-12 d-sm-block d-md-none">
                    <p>Partner with Bhavi Creations to transform your marketing collateral into impactful brand assets
                        that resonate with your target audience. Our team of experienced designers will work closely
                        with you to understand your brand identity, messaging, and goals, crafting custom pamphlet
                        designs that capture the essence of your brand and communicate your message effectively.</p>
                </div>

                <div class="col-12 d-block d-lg-none  ">

                    <p> Stand out from the competition and make a lasting impression with professionally designed
                        pamphlets from Bhavi Creations.</p>
                ...
                <div class="d-block d-xl-none">
                    ...
                    <div class="my-3  ">
                        <a href="contact_us.php" style="text-decoration: none;"> <button class=" know_more_btn"> Know
                                More
                            </button></a>
                    </div>
    ...
    <section class=" " style="margin-top:  90px; ">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6  col-lg-3 d-flex flex-column justify-content-center">
                    <h1 class="large_text">Direct Audience Engagement</h1>
                    <p>Engage your target audience directly with pamphlets, a tangible marketing solution perfect for
                        events, trade shows, or storefronts.</p>
                </div>

                <div class="col-md-6 col-lg-6">
                    <img src="assests/images/online-branding/phamplet8_cleanup.webp" class="img-fluid" alt="">
                </div>
                ...
                <div class=" col-3 d-none d-lg-block">
                    ...
                    <div class=" ">
                        ...
                        <p>Maximize your marketing budget with pamphlets, offering informative content and
                            cost-effective production for businesses of all sizes. </p>

                    </div>
                    <div class=" last_sec_text_div   ">

                        <h1 class="large_text">
                            Connect with Us
                        </h1>
                        <p>Ready to elevate your marketing strategy with pamphlets? Get in touch with us today to
                            explore customized solutions for your business. </p>
