...
<body>
    ...
    <div class="container">
        ...
        <div class="row g-2 mb-4 row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6 media-tab-buttons mx-1  justify-content-center align-items-center" >
            <div><button class="media-tab-btn active" onclick="showMediaTab(event, 'website')">website</button></div>
        ...
        <div id="website" class="media-tab-content active">
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class='card'>
                        ...
                        echo "<div class='col-12'><p class='text-muted text-center'>No website uploaded yet.</p></div>";
                    }
    ...
    <script>
        ...
        function showTabFromHash() {
            ...
            const validTabs = ['website', 'all', 'images', 'videos', 'logos']; // Add more if needed

            const defaultTab = 'website';
