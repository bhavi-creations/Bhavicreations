...
<head>
    ...
    <meta name="description" content="Your hoardings description">
...
<body>
    ...
    <div class="container">
        ...
        <div class="row g-2 mb-4 row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6 media-tab-buttons mx-1 justify-content-center align-items-center">
            <div><button class="media-tab-btn active" onclick="showMediaTab(event, 'hoardings')">hoardings</button></div>
        ...
        <div id="hoardings" class="media-tab-content active">
            <div class="row">
        ...
        <div id="hoardings" class="media-tab-content">
            <div class="row">
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    echo "<div class='col-12'><p class='text-muted text-center'>No hoardings media uploaded yet.</p></div>";
                }
    ...
    <script>
        ...
        function showTabFromHash() {
            ...
            const validTabs = ['hoardings', 'all', 'images', 'videos', 'logos']; // Add more if needed

            const defaultTab = 'hoardings';
