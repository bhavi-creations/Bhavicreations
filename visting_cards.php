        ...
        <div class="container head">
            <div class="row">
                <div class="col-lg-8 d-flex flex-column justify-content-center">
                    ...
                    <h2 style="color: rgb(0, 0, 0);" class=""><strong>Make Your Mark with Visiting Cards</strong> </h2>
                    <p style="color: rgb(0, 0, 0);">Elevate your professional image with meticulously crafted visiting
                        cards designed to leave a lasting impression. At Bhavi Creations, we understand the importance
                        of making a statement with every exchange, and our visiting card designs reflect your commitment
                        to professionalism and excellence. Let us help you stand out and make connections that matter
                        with our bespoke visiting card solutions.
                    </p>
                </div>
                <div class="col-lg-4 ">
                    <div class="e-card playing">
                        ...
                        <div class="infotop"><strong>
                                Bhavi Creations</strong>
                            <br>
                            <div class="name"><strong>WE'RE HERE TO HELP YOU TO SHINE</strong></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container mt-5">
            <div class="row">
                    ...
                    <div class="iphone_card   ">
                        ...
                        <div class="card-int">
                            <a href="contact_us.php" style="text-decoration: none;">
                                <div class="hello">Upgrade Your Identity Into professionality
                                    <span class="hidden">Bhavi Creations</span>
                                </div>
                            </a>
                        </div>
                ...
                <div class="col-lg-8">
                    ...
                    <h1 class="large_text">Personalized Design</h1>
                    <p>Our visiting cards offer personalized design options tailored to reflect your unique brand
                        identity and professional style, ensuring that every card makes a memorable impression.</p>

                    <div class=" my-3 row" style="background-color: rgba(241, 61, 241, 0.432); border-radius: 2px;">
                        <div class="col-6 p-4">
                            <h3><strong>Custom Branding</strong></h3>
                            <p> Tailor your visiting cards with your brand logo, colors, and fonts, creating a cohesive
                                and recognizable brand identity with every exchange.
                            </p>


                            <!-- <button class="cls_btn_fold">
                            <b>Click me!</b>
                        </button> -->
                        </div>
                        ...
                        <div class="col-6 d-flex flex-column justify-content-center">
                            <img src="assests/images/Bhavi_Creations/best_visiting_card_mythri_enterptises_designing_bhavi_creations.webp"
                                class="img-fluid" alt="">
                        </div>

                    </div>

                    <div class=" my-3   row" style="background-color: rgba(241, 187, 61, 0.432); border-radius: 2px;">
                        <div class="col-6 p-4">
                            <h3><strong>Premium Materials</strong></h3>
                            <p> Choose from a selection of high-quality paper stocks, finishes, and printing techniques
                                to elevate the look and feel of your visiting cards, leaving a lasting impression on
                                recipients.</p>
                        ...
                        <div class="col-6 d-flex flex-column justify-content-center">
                            <img src="assests/images/Bhavi_Creations/best_visiting_card_Harsha_kommisetti_designing_bhavi_creations.webp"
                                class="img-fluid" alt="">
                        </div>

                    </div>

                    <div class=" my-3   row" style="background-color: rgba(61, 241, 235, 0.432); border-radius: 2px;">
                        <div class="col-6 p-4">
                            <h3><strong>Innovative Layouts</strong></h3>
                            <p>Stand out from the crowd with innovative design layouts and creative elements that
                                capture attention and showcase your creativity and professionalism.
                            </p>
                        ...
                        <div class="col-6 d-flex flex-column justify-content-center">
                            <img src="assests/images/Bhavi_Creations/best_visiting_card_srinivasa_dental_designing_bhavi_creations.webp"
                                class="img-fluid" alt="">
                        </div>
    ...
    <section class="mt-5">
        <div class="container">
            <div class="row" style="justify-content: space-evenly;">
                <h2 class="text-center large_text    ">
                    <strong>Key Benefits of Professional Visiting Cards</strong>
                </h2>
                <div class="col-lg-5 cards mt-4 p-2" style="border-radius: 5px; background-color: #f8bad3;">
                    <h3 class="pl-2">First Impression</h2>
                        <p class="pl-4">Make a memorable impact with professionally designed visiting cards that reflect
                            your attention to detail and commitment to quality. Elevate your brand image from the very
                            first interaction, setting the stage for meaningful connections and future collaborations.
                        </p>
                </div>
                <div class="col-lg-5 cards mt-4 p-2" style="border-radius: 5px; background-color: #f8e1ba;">
                    <!-- <img src="assests/images/bhavi/changeimg1 (1).jpg" alt="" class="img-fluid"> -->
                    <h3 class="pl-2">Brand Identity</h2>
                        <p class="pl-4">Personalize your visiting cards to embody your brand's unique identity, values,
                            and aesthetic. With customizable design elements and premium materials, your brand story
                            comes to life, leaving a lasting impression on recipients and reinforcing your brand's
                            credibility and recognition.</p>

                </div>
            </div>
            <div class="row mt-4" style="justify-content: space-evenly; ">
                <div class="col-lg-5 cards mt-4  p-2" style="border-radius: 5px; background-color: #baf1f8;">
                    <h3 class="pl-2">Differentiation and Memorability </h2>
                        <p class="pl-4">Stand out in a crowded marketplace with distinctive visiting card designs that
                            capture attention and spark conversation. From innovative layouts to bespoke finishes, each
                            card is crafted to be memorable, ensuring that you leave a lasting impact on clients,
                            prospects, and business partners.</p>
                </div>
                <div class="col-lg-5 cards mt-4  p-2" style="border-radius: 5px; background-color: #e9baf8;">
                    <!-- <img src="assests/images/bhavi/changeimg1 (1).jpg" alt="" class="img-fluid"> -->
                    <h3 class="pl-2">Networking and Professionalism</h2>
                        <p class="pl-4">Equip yourself with professional visiting cards that not only provide essential
                            contact information but also convey professionalism, reliability, and integrity. Showcase
                            your commitment to excellence and dedication to building lasting relationships, empowering
                            you to network with confidence and credibility.</p>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="  col-md-4   p-2 ">
                    <img src="assests/images/Bhavi_Creations/best_visiting_card_designs_inkkd_mythri_enterprises_bhavi_creations.webp"
                        class="img-fluid" />

                </div>
                <div class="  col-md-4   p-2 ">
                    <img src="assests/images/Bhavi_Creations/best_visiting_card_designs_inkkd_kommisetti_bhavi_creations.webp"
                        class="img-fluid" />

                </div>
                <div class="  col-md-4   p-2 ">
                    <img src="assests/images/Bhavi_Creations/best_visiting_card_designs_inkkd_srinivasa_dentel_bhavi_creations.webp"
                        class="img-fluid" />

                </div>
                <div class="col-md-3  p-2">
                    <img src="assests/images/online-branding/Business Card.webp" class="img-fluid" />

                </div>
                <div class="col-md-3  p-2">
                    <img src="assests/images/online-branding/Business Card 2.webp" class="img-fluid" />

                </div>
                <div class="col-md-3  p-2">
                    <img src="assests/images/online-branding/Business Card3.webp" class="img-fluid" />

                </div>
                <div class="col-md-3  p-2">
                    <img src="assests/images/online-branding/Business Card9.webp" class="img-fluid" />
                </div>
                <div class="  col-md-4   p-2 ">
                    <img src="assests/images/online-branding/Business Card10.webp" class="img-fluid" />
                </div>
                <div class="  col-md-4   p-2 ">
                    <img src="assests/images/online-branding/Business Card11.webp" class="img-fluid" />
                </div>
                <div class="  col-md-4   p-2 ">
                    <img src="assests/images/online-branding/Business Card12.webp" class="img-fluid" />
                </div>
                <div class="col-md-6 p-2">
                    <img src="assests/images/online-branding/Business Card13.webp" class="img-fluid" />
                </div>
                <div class="col-md-6 p-2">
                    <img src="assests/images/online-branding/Business Card14.webp" class="img-fluid" />
                </div>
            </div>
        </div>
    </section>
