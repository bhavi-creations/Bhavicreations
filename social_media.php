...
<body>
    ...
    <div class="loader_butterflu" style="margin-bottom:-80px">
    ...
    <section class="p-5" style="background-color:#bfdfff; margin-top:-10px">
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="large_text">Social Media Manage</h1>
                    <p class="normal_text">
                        Explore the dynamic world of social media with Bhavi Creations. From strategic planning to
                        content creation, we offer comprehensive solutions for your brand's digital journey. Let us
                        navigate the intricacies of social media marketing, unlocking opportunities for your brand's
                        growth and success.</p>
                </div>
                <div
                    class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 d-none d-md-block order-md-1 order-lg-1 order-xl-1 ">
                    <div class="card shadow soc-title1 " style="width: 18rem;height:300px">
                        <div class="card-body">
                            <p class="card-text">Elevating your brand's digital presence through strategic planning and
                                engaging content creation.</p>
                            <p class="card-text"> Fostering meaningful interactions and building relationships with your
                                audience to drive growth and loyalty.</p>
                        </div>
                    </div>
                </div>
                <div
                    class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 order-md-3 order-lg-3 order-xl-3 d-flex flex-row justify-content-center">
                    <img src="assests/images/bhavi/socialmediaimg1-removebg-preview.webp" class="img-fluid soc-title2" />
                </div>

                <div class="col-3 d-none d-md-block col-lg-6 col-xl-6 col-md-6 order-md-2 order-lg-2 order-xl-2">
                    <div class=" d-flex flex-row justify-content-end ">
                        <video controls class="img-fluid shadow" muted autoplay loop>
                            <source src="assests/images/online-branding/social_video.mp4" type="video/mp4">
                ...
                <div
                    class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 order-md-4 d-none d-md-block  order-lg-4 order-xl-4">
                    <img src="assests/images/Bhavi_Creations/best_socila_media_company_managment_digital_markting_bhavi_creations.webp"
                        class="img-fluid soc-title4" />
                </div>
                <div class="col-4 d-none d-md-block col-md-6 col-lg-6 col-xl-6 order-md-5 order-lg-5 order-xl-5">
                    <div class=" d-flex flex-row justify-content-end ">
                        <img src="assests/images/Bhavi_Creations/best_socila_media_company_managment_markting_bhavi_creations.webp"
                            class="img-fluid soc-title5" />
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 ms-auto mt-2 order-md-6 order-lg-6 order-xl-6">
                    <div class="social-buttons soc-title6">
                        <a href="https://www.youtube.com/@bhavicreationspvtltd" target="_blank"
            ...
            c-2.762,0-5,2.238-5,5v50.844C76.703,162.867,78.941,165.106,81.703,165.106z"></path>
                        ...
                        <a href="https://www.instagram.com/bhavicreations_pvtltd/ " target="_blank"
    ...
    <section class="mt-5 mb-5">
        <div class="container">
            <div class="col-12 text-center">
                <h2 class="large_text">Empowering Social Media Insights</h2>
                <p class="normal_text">
                    At Bhavi Creations, we empower your brand with comprehensive social media insights. Through advanced
                    analytics and audience understanding, we provide actionable data to refine your strategies, enhance
                    engagement, and drive meaningful results in the dynamic world of social media. Unlock the power of
                    data-driven decisions and elevate your digital presence with Bhavi Creations.</p>
            </div>
        </div>
    </section>
    <!-- section 2  -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 ">
                    <div class="card p-2 shadow soc-card1" style="background-color:rgb(243, 230, 255)">
                        <img src="assests/images/Bhavi_Creations/best_performance_tracking_digital_markting_company_bhavi_creations.webp"
                            class="img-fluid" />
                        <h5 class="mt-2 mix_up_text">Performance Tracking</h5>
                        <p>Monitor the effectiveness of your social media campaigns with detailed analytics, providing
                            insights into engagement, reach, and conversion metrics. </p>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4 " style="margin-top:100px">
                    <div class="card p-2 shadow soc-card2" style="background-color:rgb(230, 232, 255)">
                        <img src="assests/images/Bhavi_Creations/best_auidence_insights_digital_markting_company_bhavi_creations.webp"
                            class="img-fluid" style="background-color:rgb(231, 205, 255);height:210px" />
                        <h5 class="mt-2 mix_up_text">Audience Insights</h5>
                        <p>Gain a deeper understanding of your audience demographics, interests, and behavior,
                            empowering targeted content strategies and audience engagement.</p>
                    </div>
                </div>
                <div class="col-12 col-sm-12 col-md-12 col-lg-4 col-xl-4" style="margin-top:200px">
                    <div class="card p-2 shadow soc-card3" style="background-color:rgb(255, 230, 238)">
                        <img src="assests/images/Bhavi_Creations/best_digital_markting_Competitive_Analysis_company_bhavi_creations.webp"
                            class="img-fluid" />
                        <h5 class="mt-2 mix_up_text">Competitive Analysis</h5>
                        <p>Benchmark your brand's social media performance against competitors, identifying strengths,
                            weaknesses, and opportunities for improvement. </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="mt-5 p-5 lastsec">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="lastsec normal_text">In conclusion, Bhavi Creations is dedicated to leveraging the power
                        of social media marketing to help businesses thrive in the digital age. With a strategic
                        approach tailored to each client's unique needs, we craft compelling social media campaigns that
                        drive engagement, build brand awareness, and foster meaningful connections with target
                        audiences.
                    </p>
                    <p class="normal_text">At Bhavi Creations, we empower your brand with comprehensive social media
                        insights. Through advanced analytics and audience understanding, we provide actionable data to
                        refine your strategies, enhance engagement, and drive meaningful results in the dynamic world of
                        social media. Unlock the power of data-driven decisions and elevate your digital presence with
                        Bhavi Creations. Reach out to us today and let's embark on a journey towards social media
                        success together.</p>
                </div>
            </div>
        </div>
