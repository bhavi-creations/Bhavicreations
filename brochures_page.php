...
<head>
    ...
    <meta name="description" content="Your brochures description">
...
<body>
        ...
        <div id="brochures" class="media-tab-content">
            <div class="row">
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    echo "<div class='col-12'><p class='text-muted text-center'>No brochures media uploaded yet.</p></div>";
                }
    ...
    <script>
        ...
        function showTabFromHash() {
            ...
            const validTabs = ['brochures', 'all', 'images', 'videos', 'logos']; // Add more if needed

            const defaultTab = 'brochures';
