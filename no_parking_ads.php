...
<head>
    ...
    <title>No-Parking Bhavi Creations</title>
...
<body style="background-color: rgb(255, 255, 255); overflow-x: hidden;">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class=" col-3 d-none d-lg-block">
                    ...
                    <div class="  animate_animated animate_backInLeft">

                        <h1 class="large_text">
                            Increasing Awareness
                        </h1>
                        <p>No parking ads serve as a crucial tool for raising awareness about parking regulations and
                            ensuring compliance. By strategically placing these ads in high-traffic areas, we can
                            effectively communicate parking rules and restrictions to motorists, pedestrians, and
                            residents. </p>

                    </div>
                    <div class=" last_sec_text_div   animate_animated animate_backInUp " style="margin-top:-6px">

                        <h1 class="large_text">
                            Enhancing Safety
                        </h1>
                        <p>No parking ads play a vital role in promoting safety on roads and sidewalks by preventing
                            unauthorized parking in restricted areas. These ads help maintain clear sightlines for
                            drivers and pedestrians, reduce congestion, and minimize the risk of accidents or
                            obstructions.</p>
                ...
                <div class="col-md-6 col-lg-6 animate_animated animate_backInDown">
                    <img src="assests/images/Bhavi_Creations/no-parking-1.webp" class="img-fluid" alt="">
                </div>
                ...
                <div
                    class="col-md-6  col-lg-3 d-flex flex-column justify-content-center  animate_animated animate_backInRight">
                    <h1 class="large_text"> Improving Accessibility</h1>
                    <p>No parking ads contribute to improving accessibility for emergency vehicles, public
                        transportation, and pedestrians by ensuring unobstructed pathways and entry points.</p>
                </div>
            ...
            <div class=" col-12 d-block d-lg-none">
                ...
                <div class=" row ">
                    <div class=" col-sm-12 col-md-6">
                        ...
                        <h1 style="font-weight: bold; color: rgb(123, 123, 123);">
                            Enhancing Safety
                        </h1>
                        <p>No parking ads play a vital role in promoting safety on roads and sidewalks by preventing
                            unauthorized parking in restricted areas. These ads help maintain clear sightlines for
    ...
    <section style="margin-top: 100px;">
        <div class="container d-none d-md-block">
            <div class="row">
                <div class="col-8">
                    <img src="assests/images/Bhavi_Creations/no parking2.webp" class="img-fluid" alt="">
                </div>

                <div class="col-4">

                    <img src="assests/images/Bhavi_Creations/no parking3.webp" class="img-fluid mb-3" alt="">
                    <img src="assests/images/Bhavi_Creations/no parking 4.webp" class="img-fluid  mb-3 " alt="">
                    <img src="assests/images/Bhavi_Creations/no parking 5.webp" class="img-fluid" alt="">
        ...
        <div class="container d-block d-md-none">
            <div class="row">
                ...
                <div style="text-align: center;">
                    ...
                    <img src="assests/images/Bhavi_Creations/no parking3.webp" class="img-fluid mb-3   " alt="">
                    <img src="assests/images/Bhavi_Creations/no parking 4.webp" class="img-fluid  mb-3 " alt="">
                    <img src="assests/images/Bhavi_Creations/no parking 5.webp" class="img-fluid mb-3 " alt="">
    ...
    <section style="margin-top: 100px;">
        ...
        <div class="container">
            <div class="row">
                <div class="col-7">
                    ...
                    <div class="row ">
                        <div class="col-4 mr-5">
                            <h1 class="large_text" style="font-weight: bold; font-size:30px">Harnessing the Power of No
                                Parking Ads</h1>
                        </div>

                        <div class="col-7 d-none d-md-block">
                            <p>No parking ads offer a powerful way to communicate important messages and regulations to
                                the public. From designated parking zones to loading zones and fire hydrants, these ads
                                help maintain order, safety, and accessibility in busy urban areas.</p>
                        </div>
                    ...
                    <div class="d-none d-lg-block">
                        <div class="mt-5">
                            <p>
                                By partnering with Bhavi Creations, you can leverage our expertise in designing and
                                deploying effective no parking ads that make a meaningful impact on your community.
                            </p>
                        </div>
                    </div>
                    <div class="d-none d-lg-block">
                        <div class="mt-5">
                            <p>
                                ...
                                Our tailored approach ensures that your message is clear, concise, and visually
                                compelling, maximizing engagement and compliance. With Bhavi Creations as your partner,
                                you can trust us to deliver impactful solutions that address your community's parking
                                challenges while enhancing overall safety and convenience.
                            </p>
                        </div>
                    </div>
                    <div class="mt-1 d-none d-xl-block">
                        <button class=" know_more_btn"> Contact us
                        </button>
                    </div>
                ...
                <div class="col-5">
                    <img src="assests/images/Bhavi_Creations/no parking 9.webp" class=" img-fluid" alt="">
                </div>

                <div class="col-12 d-sm-block d-md-none">
                    <p>No parking ads offer a powerful way to communicate important messages and regulations to the
                        public. From designated parking zones to loading zones and fire hydrants, these ads help
                        maintain order, safety, and accessibility in busy urban areas.</p>
                </div>

                <div class="col-12 d-block d-lg-none  ">

                    <p> By partnering with Bhavi Creations, you can leverage our expertise in designing and deploying
                        effective no parking ads that make a meaningful impact on your community.</p>

                </div>
                <div class="col-12 d-block d-lg-none ">
                    <div class="mt-5">
                        <p>
                            Our tailored approach ensures that your message is clear, concise, and visually compelling,
                            maximizing engagement and compliance. With Bhavi Creations as your partner, you can trust us
                            to deliver impactful solutions that address your community's parking challenges while
                            enhancing overall safety and convenience.
                        </p>
                    </div>
                </div>
                ...
                <div class="d-block d-xl-none">
                    ...
                    <div class="my-3  ">
                        <a href="contact_us.php"><button class=" know_more_btn">Contact us
                            </button></a>
                    </div>
    ...
    <section style="margin-top: 100px;">
        <div class="container my-5">
            <hr style="border: none; height: 6px; background-color: rgb(76, 76, 76);">
        </div>
    </section>
    ...
    <section style="margin-top: 100px;">
        <div class="container">
            <div class="row">
                <div class="col-md-6 order-1  order-md-1 p-5" style="background-color: silver;  ">
                    <h2 class="mix_up_text" style="font-size: 25px;">Ensuring Safety</h2>

                    <img src="assests/images/Bhavi_Creations/no parking 8.webp" class="img-fluid" alt="">
                    <!-- <h5>Lorem ipsum dolor sit amet  </h5> -->
                    <p>Our no parking signs are strategically placed to maintain clear pathways for emergency vehicles,
                        ensuring swift response times and enhancing public safety.
                    </p>
                </div>
                <div class="col-md-6 pt-5  order-2  order-md-2 p-5"
                    style="background-color: rgb(70, 70, 106); color: white; font-family: Georgia, 'Times New Roman', Times, serif;">
                    <h2>Benfites</h2>
                    <p>Our mission is to create safer, more accessible communities by providing effective signage
                        solutions that promote compliance and enhance public safety.</p>
                    <ul>
                        <li>Promoting Compliance </li>
                        <li>Enhancing Public Safety </li>
                        <li>Facilitating Accessibility </li>
                        <li>Supporting Efficient Traffic Flow</li>
                        <li>Empowering Community Engagement</li>
                    </ul>


                </div>
                <div class="col-md-6 pt-5  order-4 order-md-3 p-5"
                    style="background-color: rgb(70, 70, 106); color: white; font-family: Georgia, 'Times New Roman', Times, serif;">
                    <h2>Benfites</h2>
                    <p>We envision a future where clear, informative signage contributes to smoother traffic flow,
                        reduced accidents, and improved quality of life for all residents and visitors.</p>

                    <ul>
                        <li>Smoother Traffic Flow </li>
                ...
                <div class="col-md-6   order-3 order-md-4 p-5" style="background-color: silver;">
                    <h2 class="mix_up_text" style="font-size: 25px;">Promoting Order</h2>

                    <img src="assests/images/Bhavi_Creations/no parking 10.webp" class="img-fluid" alt="">

                    <!-- <h5>Lorem ipsum dolor sit amet  </h5> -->
                    <p>With clear signage and messaging, we communicate parking regulations effectively, minimizing
                        congestion and improving traffic flow in busy areas.</p>
                </div>
            </div>
        </div>
    </section>
