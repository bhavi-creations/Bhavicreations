...
<head>
    ...
    <title>theater Bhavi Creations</title>
...
<body>
    ...
    <div class="loader_butterflu" style="margin-bottom: -78px;">
    ...
    <section style="margin-top: -20px;">
        ...
        <div class="video-container">
            <video controls class="img-fluid mt-2" muted autoplay loop>
                <source src="assests/images/bhavi/Red screen.mp4" type="video/mp4">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6  col-md-4  mb-4">
                    <img src="assests/images/Bhavi_Creations/best_theater_ads_making_company_bhavi_creations.webp"
                        class="img-fluid" alt="">
                </div>

                <div class="col-6  col-md-4  mb-4">

                    <img src="assests/images/Bhavi_Creations/best_theater_ads_digitial_markting_making_company_bhavi_creations.webp"
                        class="img-fluid" alt="">
                </div>
                <div class="col-6  col-md-4  mb-4">

                    <img src="assests/images/Bhavi_Creations/best_theater_ads_digitial_making_company_bhavi_creations.webp"
                        class="img-fluid" alt="">
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-4">
                    <h3 class="text-center  mix_up_text" style="font-size: 26px;">Captivating Visuals</h3>
                    <p class="normal_text">Draw your audience in with captivating visuals that leave a lasting
                        impression. </p>
                    <p class="normal_text">Our theatre ads are designed to command attention and spark curiosity,
                        ensuring maximum impact on the big screen. </p>


                    <!-- <div class=" d-flex flex-row justify-content-center">
                    <button class="theater_btn "> More
                    </button>
                </div> -->

                </div>
                <div class="col-sm-12 col-md-4">
                    <h3 class="text-center   mix_up_text" style="font-size: 26px;">Engaging Storytelling</h3>
                    <p class="normal_text">Tell your brand story in a compelling and memorable way with our theatre
                        advertisements.</p>
                    <p class="normal_text"> From heartfelt narratives to thrilling adventures, we craft engaging stories
                        that resonate with your audience and drive action. </p>
                ...
                <div class="col-sm-12 col-md-4">
                    <h3 class="text-center   mix_up_text" style="font-size: 26px;">Immersive Experience</h3>
                    <p class="normal_text">Create an immersive experience for your audience with our dynamic theatre
                        ads.</p>
                    <p class="normal_text"> With stunning visuals, immersive sound, and captivating storytelling, we
                        transport viewers into your brand's world, leaving them eager to learn more.</p>
    ...
    <section style="margin-top: 100px;">
        <div class="container my-5">
            <hr style="border: none; height: 4px; background-color: rgb(255, 0, 0);">
        </div>
    </section>
        ...
        <div class="container mb-5">
            <div class="row">
                <div class="col-sm-12 col-lg-5">
                    <h3 class="     flex-row justify-content-left  mix_up_text" style="font-size: 26px;">Let's Elevate
                        Your Brand<br /> with Theatre Ads</h3>
                    <p class="normal_text">Incorporate the power of theatre advertising into your marketing strategy and
                        elevate your brand to new heights. Our team at Bhavi Creations specializes in creating
                        compelling theatre ads that captivate audiences and drive results. </p>
                    <p class="normal_text">From concept development to production and placement, we handle every aspect
                        of your theatre ad campaign with precision and creativity. Get in touch with us today to discuss
                        your goals and discover how theatre advertising can take your brand to the next level.</p>


                    <div class=" d-flex flex-row justify-content-left">
                        <a href="contact_us.php"><button class="theater_btn ">Connect Us
                            </button></a>
                    </div>
                ...
                <div class="col-sm-12 col-lg-7">
                    <div class="video-container">
                        <img src="assests/images/Bhavi_Creations/theatre ads1.webp" class="img-fluid">
                    </div>
                </div>
