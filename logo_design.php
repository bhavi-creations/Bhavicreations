...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    ...
                    ">Logo</span> Design</h1>
                    <p class="paragraph1 mt-5">Welcome to Bhavi Creations, where we understand the profound impact of a
                        well-designed logo in shaping your brand identity. Your logo is the visual cornerstone of your
                        brand, the first impression that speaks volumes about who you are and what you stand for. It's
                        not just a symbol; it's the embodiment of your values, your mission, and your unique essence.
                    </p>
                    <p class="paragraph1">We craft logos that go beyond mere visuals; they communicate your brand's
                        essence, establish credibility, and foster recognition. Think of iconic logos like Nike's swoosh
                        or McDonald's golden arches – instantly recognizable symbols of excellence.
                    </p>
                    <p class="paragraph1 ">Our talented designers specialize in crafting logos that resonate with your
                        audience and make a lasting impression. We delve into your brand story and aspirations to create
                        a logo that encapsulates your brand's essence.
                    </p>
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
                    <img src="./assests/images/bhavi/Logo Gride.webp" class="img-fluid image" />
                    <p class="logodesign-para text-center">Using A Lines Method</p>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <div class="card shadow  p-4">
                        <div class="row" style="margin-top: -70px;">
                            <div class="col-12 col-md-6 ">
                                <div class="row">
                                    ...
                                    <div class="col-6 col-sm-6 col-md-4 mb-3">
                                        <img src="assests/images/Bhavi_Creations/best_logo_designes_rs_eye_hospital_bhavi_creations.webp"
                                            onclick="changeImage('assests/images/Bhavi_Creations/best_logo_design_rs_eye_hospital_Black_hoodie_bhavi_creations.webp')"
                                            class="img-fluid shadow image1" />
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-4 mb-3">
                                        <img src="assests/images/Bhavi_Creations/best_logo_designes_bhavi_logo_bhavi_creations.webp"
                                            onclick="changeImage('assests/images/Bhavi_Creations/best_logo_design_rs_bhavi_logo_Black_hoodie_bhavi_creations.webp')"
                                            class="img-fluid shadow image2" />
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-4 mb-3">
                                        <img src="assests/images/Bhavi_Creations/best_logo_designes_hindu_dharmika_bhavi_creations.webp"
                                            onclick="changeImage('assests/images/Bhavi_Creations/best_logo_design_rs_hindu_dharmika_logo_Black_hoodie_bhavi_creations.webp')"
                                            class="img-fluid shadow image3" />
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                        <img src="assests/images/Bhavi_Creations/best_logo_designes_kakinada_car_carage_bhavi_creations.webp"
                                            onclick="changeImage('assests/images/Bhavi_Creations/best_logo_design_rs_car_garage_logo_Black_hoodie_bhavi_creations.webp')"
                                            class="img-fluid mt-2 shadow" />
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                        <img src="assests/images/Bhavi_Creations/best_logo_designes_aruna_couples_clinic_hospital_bhavi_creations.webp"
                                            onclick="changeImage('assests/images/Bhavi_Creations/best_logo_design_rs_aruna_couples_clinic_logo_Black_hoodie_bhavi_creations.webp')"
                                            class="img-fluid mt-2 shadow" />
                                    </div>
                                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                        <img src="assests/images/Bhavi_Creations/best_logo_designes_v_prime_bhavi_creations.webp"
                                            onclick="changeImage('assests/images/Bhavi_Creations/best_logo_design_rs_V_prime_logo_Black_hoodie_bhavi_creations.webp')"
                                            class="img-fluid mt-2 shadow" />
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <h2 class="card-heading text-center mt-5  large_text">We Design the Best
                                                Logos</h2>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <img src="assests/images/Bhavi_Creations/best_logo_design_rs_bhavi_logo_Black_hoodie_bhavi_creations.webp"
    ...
    <section class="mt-5 p-5 lastsec">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <p class="lastsec normal_text">Investing in a well-designed logo is an investment in your brand's
                        future. It's a cornerstone that ties together your marketing efforts, enhances brand recall, and
                        sets you apart from the competition.
                    </p>
                    <p class="normal_text"> Let Bhavi Creations be your partner in this journey of visual storytelling,
                        where every curve, color, and font choice is thoughtfully curated to elevate your brand to new
                        heights. Unleash the power of a well-designed logo with Bhavi Creations and watch as your brand
                        identity transforms into a visual masterpiece that captures hearts, minds, and markets.</p>
                </div>
            </div>
        </div>
    </section>
