...
<head>
    ...
    <meta name="description" content="Your videos description">
...
<body>
    ...
    <div class="container">
        ...
        <div id="videos" class="media-tab-content active">
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class='card'>
                        ...
                        echo "<div class='col-12'><p class='text-muted text-center'>No videos uploaded yet.</p></div>";
                    }
        ...
        <div id="videos" class="media-tab-content">
            <div class="row">
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    echo "<div class='col-12'><p class='text-muted text-center'>No videos media uploaded yet.</p></div>";
                }
    ...
    <script>
        ...
        function showTabFromHash() {
            ...
            const validTabs = ['videos', 'all', 'images', 'videos', 'logos']; // Add more if needed
