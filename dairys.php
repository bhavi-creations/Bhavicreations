...
<body style="overflow-x: hidden;">
    ...
    <section style="margin-top: -10px;">
        ...
        <img src="assests/images/bhavi/tittle img dairys.webp" alt="" class="img-fluid">
        ...
        <div class="container-fluid my-5">
            <div class="row">
                <div class="col-lg-4  d-flex flex-column justify-content-center ">
                    <h4 class="text-center animate_animated animate_shakeX large_text   " style="font-size: 24px;">
                        <strong>Get your customized
                            dairys</strong>
                    </h4>
                    <p class="text-center">Unlock the power of personalized organization with our custom diaries.
                        Crafted to your specifications, our diaries are designed to elevate your planning experience.
                    </p>
                </div>
                <div class="col-lg-8 row text-center" style="justify-content: space-evenly;">
                    <div class="col-sm-12 col-md-3 my-3">
                        <img src="assests/images/bhavi/dairy2.webp" class="img-fluid dairy_book   " alt="">
                    </div>
                    <div class="col-sm-12 col-md-3  my-3">
                        <img src="assests/images/bhavi/dairy 1 (1).webp" class="img-fluid  dairy_book  " alt="">
                    </div>

                    <div class="col-sm-12 col-md-3 my-3">
                        <img src="assests/images/bhavi/dairy3.webp" class="img-fluid dairy_book" alt="">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 order-2 order-md-1 ">
                    <img src="assests/images/bhavi/Quality_care_cover_mockup-removebg-preview.webp" class="img-fluid"
                        alt="">
                </div>
                <div class="col-md-6 d-flex flex-column justify-content-center order-1 order-md-2">
                    <h4 class=" large_text   " style="font-size: 24px;"><strong>Always there for you for your best
                            designs</strong> </h4>
                    <p>Count on Bhavi Creations for exceptional diary designs that align perfectly with your style and
                        needs. Our team is dedicated to delivering personalized solutions that cater to your unique
                        preferences, ensuring your diary is both functional and stylish. Experience the convenience of
                        custom diaries tailored to your every requirement.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6  d-flex flex-column justify-content-center">
                    <h4 class=" large_text   " style="font-size: 24px;"><strong>We are Avilible 24/7 for your
                            service</strong></h4>
                    <p>Whether you need assistance, have questions, or want to discuss your project, our team is here
                        for you round the clock. With Bhavi Creations, expect reliable support whenever you need it,
                        ensuring a seamless and satisfying experience every step of the way.</p>
                </div>
                <div class="col-md-6">
                    <img src="assests/images/bhavi/Neurostatr_cover_mockup-removebg-preview.webp" class="img-fluid"
                        alt="">
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row text-center" style="justify-content: space-evenly; ">
                <div class="col-6  col-md-2  mt-3">
                    <img src="assests/images/bhavi/mini_dairy.webp" class="img-fluid dairy_book   " alt="">
                </div>
                <div class="col-6  col-md-2  mt-3">
                    <img src="assests/images/bhavi/mini_dairy_2.webp" class="img-fluid dairy_book   " alt="">
                </div>
                <div class="col-6  col-md-2  mt-3">
                    <img src="assests/images/bhavi/mini_dairy_4.webp" class="img-fluid dairy_book   " alt="">
                </div>
                <div class="col-6  col-md-2  mt-3">
                    <img src="assests/images/bhavi/mini_dairy_5.webp" class="img-fluid dairy_book   " alt="">
                </div>
                <div class=" col-6 col-md-2  mt-3">
                    <img src="assests/images/bhavi/mini_dairy_6.webp" class="img-fluid dairy_book   " alt="">
                </div>
                ...
                <div class="d-none d-md-block">
                    ...
                    border-top: 25px solid rgb(186, 113, 16);  
                    box-shadow: -5px 5px 5px black, 5px -5px 5px rgb(255, 255, 255); 
