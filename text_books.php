...
<body>
    ...
    <section style="margin-top: -10px;">
        <img src="assests/images/update_img/best_text_books_bhavi_creations_22.webp" alt="" class="img-fluid mb-5">
    </section>
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-sm-6 cl-md-3 ">
                    <img src="assests/images/update_img/best_text_books_bhavi_creations_12.webp" alt=""
                        class="img-fluid">
                </div>
                <div class="col-lg-3 col-sm-6 cl-md-3">
                    <img src="assests/images/update_img/best_text_books_bhavi_creations_13.webp" alt=""
                        class="img-fluid">
                </div>
                <div class="col-lg-3 col-sm-6 cl-md-3 ">
                    <img src="assests/images/update_img/best_text_books_bhavi_creations_14.webp" alt=""
                        class="img-fluid">
                </div>
                <div class="col-lg-3 col-sm-6 cl-md-3">
                    <img src="assests/images/update_img/best_text_books_bhavi_creations_11.webp" alt=""
                        class="img-fluid">
                </div>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-lg-3 col-sm-12 col-md-6 mt-5">
                    <img src="assests/images/update_img/books_bahvi_creations_1.webp" alt="" class="img-fluid">
                </div>
                <div class=" col-xl-9 col-lg-6 col-sm-12 col-md-6  pt-5 mt-5">
                    <p style="text-align: justify;" class="normal_text">In the realm of education, textbooks stand as
                        indispensable tools for both students and educators alike. At Bhavi Creations, we recognize the
                        pivotal role textbooks play in shaping learning experiences and facilitating knowledge
                        dissemination. Our commitment lies in crafting comprehensive and meticulously curated textbooks
                        that not only align with academic standards but also foster engagement, critical thinking, and
                        conceptual understanding among students.</p>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-12 text-center">
                    <img src="assests/images/update_img/best_text_books_designs_bhavi_creations.webp" alt=""
                        class="img-fluid" ">
                </div>
            </div>
        </div>
    ...
    <section>
        <div class=" container mt-5">
                    <div class="row">
                        <div class="col-xl-9 col-lg-6  col-sm-12 col-md-6">

                            <p style="text-align: justify;" class=" mt-5 normal_text">With a team of experienced
                                writers, editors, and subject matter experts, we meticulously develop textbooks that
                                cater to diverse educational needs and learning styles. From primary education to higher
                                academia, our textbooks are designed to provide structured content, clear explanations,
                                and interactive elements that enhance the learning journey. At Bhavi Creations, we
                                strive to empower educators and inspire students through innovative textbook solutions
                                that lay the foundation for a lifelong pursuit of knowledge and academic success.</p>

                        </div>
                        <div class="col-lg-3 col-sm-12 col-md-6 mt-5">
                            <img src="assests/images/update_img/books_bahvi_creations.webp" alt="" class="img-fluid">
