...
<head>
  ...
  <link rel="stylesheet" href="assests/digital_animation.css">
...
<div class="loader_butterflu" style="margin-bottom: -70px;">
  ...
  <section style="margin-top: -10px;">
   <img src="assests/images/Bhavi_Creations/best_graphic_designing_making_company_bhavi_creations.webp"  class="img-fluid" alt="">
  </section>
      ...
      <div class="row">
        <div class="col-12">
          <!-- <p>Projects</p>
                          ...
                          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias esse, eum, cum necessitatibus totam, velit eligendi ex quis non molestiae earum. Eaque, placeat nulla quibusdam similique a aliquam quae iure.</p> -->
          <h2 class=" mt-3 large_text">
            Videos</h2>
          <p class="normal_text">From promotional content to storytelling narratives, our videos are crafted with the user in mind. We
            ensure that each video is engaging, informative, and tailored to meet the needs and preferences of your
            target audience, driving action and enhancing the overall user experience.
          </p>
        </div>
      </div>
    </div>
  ...
  <section style="background-color:#dbedff" class="p-5">
    <div class="container">
      <div class="row">
        <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 mt-2">
          <video controls class="img-fluid shadow" muted autoplay loop>
            <source src="assests/images/Bhavi_Creations/best_reels_making_company_Brandbuzz_reel_bhavi_creations.mp4"
              type="video/mp4">
        ...
        <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 mt-2">
          <video controls class="img-fluid shadow" muted autoplay loop>
            <source
              src="assests/images/Bhavi_Creations/best_reels_making_company_sri_hari_laser_treatment_reel_bhavi_creations.mp4"
              type="video/mp4">
            Your browser does not support the video tag.
          </video>
        </div>
        <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 mt-2">
          <video controls class="img-fluid shadow" muted autoplay loop>
            <source
              src="assests/images/Bhavi_Creations/best_reels_making_company_breast_implantation_dr.subash_reel_bhavi_creations.mp4"
              type="video/mp4">
            Your browser does not support the video tag.
          </video>
        </div>
        <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3 mt-2">
          <video controls class="img-fluid shadow" muted autoplay loop>
            <source src="assests/images/Bhavi_Creations/best_reels_making_company_neuro_star_reel_bhavi_creations.mp4"
              type="video/mp4">
            Your browser does not support the video tag.
          </video>
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-2">
          <video controls class="img-fluid shadow" muted autoplay loop>
            <source
              src="assests/images/Bhavi_Creations/best_reels_making_company_subbaya_gari_hotel_reel_bhavi_creations.mp4"
              type="video/mp4">

            Your browser does not support the video tag.
          </video>
        </div>
        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 col-xl-3 mt-2">
          <video controls class="img-fluid shadow" muted autoplay loop>
            <source
              src="assests/images/Bhavi_Creations/best_reels_making_company_Aruna_couples_clinic_hospital_reel_bhavi_creations.mp4"
              type="video/mp4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h2 class=" mt-3 large_text">
            UI/UX Design</h2>
          <p  class="normal_text" >Our UI/UX design services prioritize usability and accessibility, ensuring that your digital platforms are
            intuitive, user-friendly, and visually appealing. By understanding the user's perspective, we optimize the
            user experience, resulting in higher satisfaction and engagement levels for your audience.
          </p>
        </div>
      </div>
    </div>
  </section>
  <div class="accordian d-none d-md-block mt-5" style="margin-top:-1px">

    <ul>

      <li>

        <img src="assests/images/Bhavi_Creations/best_ui_ux_designrs_preparing_bhavi_creations.webp" class="img-fluid" />

      </li>
      <li>


        <img src="assests/images/Bhavi_Creations/best_ui_ux_designrs_page_preparing_bhavi_creations.webp"
          class="img-fluid" />
      ...
      <li>
        ...
        <img src="assests/images/Bhavi_Creations/best_ui_ux_designrs_page_preparing_discussing_bhavi_creations.webp"
          class="img-fluid" />
      ...
      <li>
        ...
        <img src="assests/images/Bhavi_Creations/best_ui_ux_designrs_page_preparing_digi_market_bhavi_creations.webp"
          class="img-fluid" />
      ...
      <li>
        ...
        <img src="assests/images/Bhavi_Creations/best_ui_ux_designrs_page_preparing_best_output_bhavi_creations.webp"
          class="img-fluid" />

      </li>
    </ul>
  </div>
  <section class="mt-5 section" id="section3"
    style=" background-image: url(assests/images/online-branding/design4.webp);  background-size: cover; ">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h4 style="font-weight:bold;color:white" class="mt-3 text-center">Our Beautiful Works</h4>
          <p class="text-center" style="color:white">Evoke emotions and convey messages effectively with our
            user-centered creative images. From captivating visuals to compelling storytelling, our designs connect with
            your audience on a deeper level, fostering a stronger bond between your brand and consumers.</p>
          <!-- <div class="d-flex flex-row justify-content-center"><button class="button1" >Load More</button></div> -->
        </div>
      </div>
    </div>
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3">
          <img src="assests/images/Bhavi_Creations/best_Beautiful Works_unisol_vinayaka_chevithi_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInDown" style="margin-top:80px" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3">
          <img src="assests/images/Bhavi_Creations/best_Beautiful Works_suresh_asssisocates_diwali_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInDown" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3">
          <img src="assests/images/Bhavi_Creations/best_Beautiful Works_suresh_asssisocates_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInDown" style="margin-top:80px" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3">
          <img
            src="assests/images/Bhavi_Creations/best_Beautiful_Works_Sri_hari_republic_day_celebrations_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInDown" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 mt-3">
          <img src="assests/images/Bhavi_Creations/best_Beautiful Works_Sri_hari_republic_day_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInLeft" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 mt-3">
          <img src="assests/images/Bhavi_Creations/best_Beautiful Works_Sri_gowthi_docter_day_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInRight" style="margin-top:-80px" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 mt-3">
          <img src="assests/images/Bhavi_Creations/best_Beautiful Works_Sri hari republic day (11).webp"
            class="img-fluid animate_animated animate_bounceInUp" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 mt-3">
          <img src="assests/images/Bhavi_Creations/best_Beautiful Works_dr_subash_laser_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInUp" style="margin-top:-80px" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 mt-3">
          <img src="assests/images/Bhavi_Creations/best_Beautiful Works_dr_subash_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInLeft" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 mt-3">
          <img src="assests/images/Bhavi_Creations/best_Beautiful Works_bhr_republic_day_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInRight" style="margin-top:-80px" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 mt-3">
          <img
            src="assests/images/Bhavi_Creations/best_Beautiful Works_Bhavi_creations_republic_day_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInUp" />
        </div>
        <div class="col-6 col-sm-6 col-md-3 col-lg-3 col-xl-3 mt-3">
          <img src="assests/images/Bhavi_Creations/best_Beautiful Works_mithai_lokam_bhavi_creations.webp"
            class="img-fluid animate_animated animate_bounceInDown" style="margin-top:-80px" />
        </div>
      </div>
    </div>

    <div class="container mt-5" id="designImagesContainer">
      <!-- Design images will be dynamically added here -->
    </div>
  ...
  <section class="mt-5 p-5 lastsec">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <p class="lastsec  normal_text">In the realm of creative design, user-centered principles serve as the cornerstone of our
            approach at Bhavi Creations. From graphic design to 3D animated videos, we prioritize the needs and
            preferences of your audience, ensuring that every creative endeavor resonates deeply and drives engagement.
            Embrace the power of user-centered design across our diverse range of services to elevate your brand,
            captivate your audience, and achieve digital success.
          </p>
          <p class="normal_text"> Ready to embark on a journey of creative excellence? Contact us today to explore how our user-centered
            design approach can transform your brand's visual identity and drive meaningful connections with your
            audience. Let's collaborate to craft designs that not only inspire but also leave a lasting impact on your
            audience.
          </p>
        </div>
      </div>
